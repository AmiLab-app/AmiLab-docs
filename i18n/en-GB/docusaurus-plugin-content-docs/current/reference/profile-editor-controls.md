...
A reference for the controls in the **Shapes view**, where you design a [profile](../explanations/profiles-and-cross-sections.md). Open it from the menu (**☰**) under **Workspace → Shapes**.
...
| **Files** | Open the Files dialog to open and manage your saved profiles. |
...
| Chip | Action |
|---|---|
| **Tension** | Open the tension dialog. Tension affects the 3D preview and the generated stitch counts. |
...
| Move a point | Drag it. The bottom and top points move horizontally only (radius); points in between move freely, staying between their neighbours. |
| **+ Add point** | Insert a new control point in the largest gap along the silhouette. |
| **- Remove point** | Remove the selected point. Available only for points between the bottom and top. |
...
- [Shapes and parameters](./shapes-and-parameters.md) — generating a saved profile
