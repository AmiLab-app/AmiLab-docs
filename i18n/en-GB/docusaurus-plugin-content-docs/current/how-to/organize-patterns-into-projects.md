---
sidebar_position: 4
title: Organise your patterns into projects
description: Open, move, rename, duplicate, and group your saved patterns using the Files dialog.
---

# Organise your patterns into projects
...
In the toolbar, click **Files**. The **Projects and patterns** dialog lists each project with its tension and palette, followed by any patterns that have no project.

## Work with a pattern

Each pattern row has these actions:
...
- **Create a project** — click **New project** and set its name, tension, and palette.
- **Add a pattern to a project** — use the **New pattern** button inside a project's section, or **Move** an existing pattern into it.
