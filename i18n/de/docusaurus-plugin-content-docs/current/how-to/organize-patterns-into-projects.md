---
sidebar_position: 4
title: Anleitungen in Projekten organisieren
description: Öffne, verschiebe, benenne und dupliziere gespeicherte Anleitungen im Dateidialog und gruppiere sie in Projekten.
---

# Anleitungen in Projekten organisieren
...
Klicke in der Werkzeugleiste auf **Dateien**. Der Dialog **Projekte und Anleitungen** zeigt jedes Projekt mit Maschenprobe und Garnfarben sowie anschließend alle Anleitungen ohne Projekt.

## Mit einer Anleitung arbeiten

Für jede Anleitung stehen folgende Aktionen zur Verfügung:
...
- **Projekt erstellen** – klicke auf **Neues Projekt** und lege Name, Maschenprobe und Garnfarben fest.
- **Anleitung zu einem Projekt hinzufügen** – verwende **Neue Anleitung** im Projekt oder verschiebe eine vorhandene Anleitung dorthin.
