---
sidebar_position: 4
title: Patronen in projecten ordenen
description: Patronen openen, verplaatsen, hernoemen, dupliceren en groeperen met het venster Bestanden.
---

# Patronen in projecten ordenen
...
Klik in de werkbalk op **Bestanden**. Het venster **Projecten en patronen** toont elk project met zijn proeflapje en palet, gevolgd door eventuele patronen zonder project.

## Werken met een patroon

Elke patroonregel heeft deze acties:
...
- **Een project maken** — klik op **Nieuw project** en stel naam, proeflapje en palet in.
- **Een patroon aan een project toevoegen** — gebruik de knop **Nieuw patroon** binnen een projectgedeelte, of **Verplaats** een bestaand patroon erheen.
